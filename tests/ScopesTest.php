...
use Astrotomic\Translatable\Tests\Factories\CountryFactory;
...
final class ScopesTest extends TestCase
{
    ...
    {
        CountryFactory::new()->create(['code' => 'ca', 'name:ca' => 'Català']);
        CountryFactory::new()->create(['code' => 'fr', 'name:fr' => 'Français']);
    ...
    public function translated_in_scope_works_with_default_locale(): void
    {
        app()->setLocale('de');
        CountryFactory::new()->create(['code' => 'ca', 'name:ca' => 'Català']);
        CountryFactory::new()->create(['code' => 'el', 'name:de' => 'Griechenland']);
    ...
    public function not_translated_in_scope_returns_only_not_translated_records_for_this_locale(): void
    {
        CountryFactory::new()->create(['code' => 'ca', 'name:ca' => 'Català']);
        CountryFactory::new()->create(['code' => 'fr', 'name:fr' => 'Français']);
        CountryFactory::new()->create(['code' => 'en', 'name:en' => 'English']);
    ...
    public function not_translated_in_scope_works_with_default_locale(): void
    {
        ...
        CountryFactory::new()->create(['code' => 'ca', 'name:ca' => 'Català']);
        CountryFactory::new()->create(['code' => 'en', 'name:es' => 'Inglés']);
    ...
    {
        CountryFactory::new()->create(['code' => 'ca']);
        CountryFactory::new()->create(['code' => 'en', 'name:en' => 'English']);
    ...
    public function lists_of_translated_fields_with_fallback(): void
    {
        ...
        CountryFactory::new()->create(['code' => 'el', 'name:de' => 'Griechenland']);
        CountryFactory::new()->create(['code' => 'fr', 'name:en' => 'France']);
    ...
    {
        CountryFactory::new()->create(['code' => 'el', 'name:en' => 'Greece']);
    ...
    public function scope_withTranslation_with_fallback(): void
    {
        ...
        CountryFactory::new()->create(['code' => 'el', 'name:en' => 'Greece', 'name:de' => 'Griechenland']);
    ...
    {
        CountryFactory::new()->create(['code' => 'gr', 'name:en' => 'Greece']);
    ...
    {
        CountryFactory::new()->create(['code' => 'gr', 'name:de' => 'Griechenland']);
        CountryFactory::new()->create(['code' => 'some-code', 'name' => 'Griechenland']);
    ...
    {
        CountryFactory::new()->create(['code' => 'gr', 'name:de' => 'Griechenland']);
        CountryFactory::new()->create(['code' => 'some-code', 'name:en' => 'Griechenland']);
    ...
    {
        CountryFactory::new()->create(['code' => 'el', 'name' => 'Greece']);
        CountryFactory::new()->create(['code' => 'fr', 'name' => 'France']);
    ...
    {
        VegetableFactory::new()->create(['en' => ['name' => 'Potatoes'], 'fr' => ['name' => 'Pommes de Terre']]);
        VegetableFactory::new()->create(['en' => ['name' => 'Strawberries'], 'fr' => ['name' => 'Fraises']]);
        VegetableFactory::new()->create([]);
